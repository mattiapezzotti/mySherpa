                                            ...
                                            FirebaseDatabase.getInstance().getReference("Users")
                                                    ...
                                                    .setValue(user).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                        ...
                                                        public void onComplete(@NonNull Task<Void> task) {
                                                            ...
                                                            if(task.isSuccessful()) {
                                                                Toast.makeText(getContext(), "Utente registrato correttamente!", Toast.LENGTH_LONG).show();
                                                                loading.setVisibility(View.GONE);

                                                                Navigation.findNavController(viewNav).navigate(R.id.fragment_profile);

                                                            }else{
                                                                Toast.makeText(getContext(), "Errore nella registrazione!", Toast.LENGTH_LONG).show();
                                                                loading.setVisibility(View.GONE);
